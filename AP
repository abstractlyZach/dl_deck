...
class CardDeck:
    def __init__(self, proficiency_bonus=4):
        ...
        self.cards = [
            ...
            "Gain 1 Reaction.", "Gain 1 Reaction.", "Gain 1 Reaction.", "Gain 1 Reaction.",
            "Move # of spaces up to 2x your speed.", "Move # of spaces up to 2x your speed.",
            "Move # of spaces up to 2x your speed.", "Move # of spaces up to 2x your speed.",
            "Discard this card, draw 2 cards", "Discard this card, draw 2 cards",
            "Discard this card, draw 2 cards", "Discard this card, draw 2 cards",
            "Move # of spaces up to your speed, draw 1 card.", "Move # of spaces up to your speed, draw 1 card.",
            "Move # of spaces up to your speed, draw 1 card.", "Move # of spaces up to your speed, draw 1 card.",
            "Gain 1 Reaction, draw 2 card.", "Gain 1 Reaction, draw 2 cards.",
            "Gain 1 Reaction, draw 2 card.", "Gain 1 Reaction, draw 2 cards.",
    ...
    def auto_process_special_cards(self):
        ...
        Automatically scans your hand for any card that says:
          - "Discard this card, draw 2 cards" or 
        ...
        while special_found:
            ...
            while i < len(self.hand):
                ...
                if "discard this card, draw 2 cards" in lower_card:
                    ...
                    # Draw 2 cards—but avoid triggering auto-processing in that call
                    self.draw_cards(2, auto_process=False)
                    special_found = True
